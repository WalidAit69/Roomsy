...
// delete pictures
app.delete("/api/delete-photo/:filename", async (req, res) => {
  connectDB();
...
// delete pictures
app.delete("/api/delete-photo/:id/:filename", async (req, res) => {
  connectDB();
...
// add a place
app.post("/api/place/:Userid", async (req, res) => {
  connectDB();
...
// get places by types
app.get("/api/placesByType/:type", async (req, res) => {
  connectDB();
...
app.get("/api/placesByCountry/:country", async (req, res) => {
  connectDB();
...
// get places by owner
app.get("/api/placeByowner/:id", async (req, res) => {
  connectDB();
...
// like place
app.post("/api/save/:id/:Userid", async (req, res) => {
  connectDB();
...
//add reviews
app.post("/api/reviews/:placeid/:Userid", async (req, res) => {
  connectDB();
...
//delete reviews
app.delete("/api/deletereview/:id/:index/:Userid", async (req, res) => {
  connectDB();
...
//add booking
app.post(`/api/addBooking/:Userid`, async (req, res) => {
  connectDB();
...
//get booking by user
app.get("/api/BookingPlaces/:id", async (req, res) => {
  connectDB();
...
app.get("/api/BookPlace/:id", async (req, res) => {
  connectDB();
